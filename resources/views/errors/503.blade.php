...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Service Unavailable'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '503') - @yield('title', __('Service Unavailable'))<br/></h1>
                        <div>
                            <p>@yield('message', __('Sorry, we are undergoing maintenance. Please check back later or contact support if you need immediate assistance.'))</p>
                        </div>
                    </article>
                    <div class="margin-top-30">
                        <a href="javascript:history.go(-1)" class="btn btn-default"><i class="fa fa-arrow-left"></i> <span>Go Back</span></a>
                        <a href="{{ route('admin.dashoard') }}" class="btn btn-info"><i class="fa fa-home"></i> <span>Home</span></a>
                    </div>
                </div>
            </div>
        </div>
