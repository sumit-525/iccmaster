...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Server Error'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '500') - @yield('title', __('Server Error'))<br/></h1>
                        <div>
                            <p>@yield('message', __('Sorry, there seems to be an issue with our server. Please try again later or contact support if the problem persists.'))</p>
                        </div>
                    </article>
