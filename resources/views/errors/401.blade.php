...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Unauthorized'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '401') - @yield('title', __('Unauthorized'))<br/></h1>
                        <div>
                            <p>@yield('message', __('You are not authorized to access this page. Please log in or contact the administrator.'))</p>
                        </div>
                    </article>
                    <div class="margin-top-30">
                        <a href="javascript:history.go(-1)" class="btn btn-default"><i class="fa fa-arrow-left"></i> <span>Go Back</span></a>
                        <a href="{{ route('login') }}" class="btn btn-info"><i class="fa fa-home"></i> <span>Login</span></a>
                    </div>
                </div>
            </div>
        </div>
