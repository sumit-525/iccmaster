...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Not Found'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '404') - @yield('title', __('Not Found'))<br/></h1>
                        <div>
                            <p>@yield('message', __('The page you are looking for could not be found. Please check the URL or return to the homepage.'))</p>
                        </div>
                    </article>
