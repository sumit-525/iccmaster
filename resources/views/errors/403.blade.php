...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Forbidden'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '403') - @yield('title', __('Forbidden'))<br/></h1>
                        <div>
                            <p>@yield('message', __('User does not have the right permissions.'))</p>
                        </div>
                    </article>
