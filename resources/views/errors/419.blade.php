...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Page Expired'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '419') - @yield('title', __('Page Expired'))<br/></h1>
                        <div>
                            <p>@yield('message', __('The page you were on has expired. Please refresh the page or try logging in again.'))</p>
                        </div>
                    </article>
