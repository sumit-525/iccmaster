...
<head>
    <title>{{ config('app.name') }} - @yield('title', __('Too Many Requests'))</title>
    <meta charset="utf-8">
        ...
        <div class="vertical-align-wrap">
            <div class="vertical-align-middle maintenance">
                <div class="text-center">
                    <article>
                        <h1>@yield('code', '429') - @yield('title', __('Too Many Requests'))<br/></h1>
                        <div>
                            <p>@yield('message', __('You have made too many requests in a short period. Please try again later.'))</p>
                        </div>
                    </article>
